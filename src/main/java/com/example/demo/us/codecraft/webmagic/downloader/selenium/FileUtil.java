...
//		System.out.println(builder.toString());
	...
	public static int getHeadLen(String fileName){
		String ends = fileName.substring(fileName.lastIndexOf(".")+1);
		if(ends == null || "".equals(ends)){
			return -1;
		}
		String head = mFileTypes.get(ends.toLowerCase());
	 ...
	 * @return
	 */
	public static boolean FileIsPass(String fileName,byte[] bs){
		String head = bytesToHexString(bs);
		//获取文件后缀
		String ends = fileName.substring(fileName.lastIndexOf(".")+1);
		//根据后缀获取头信息
		String mhead = mFileTypes.get(ends.toLowerCase());
		return head.toLowerCase().equals(mhead.toLowerCase());
	}
	public static void main(String[] args) throws Exception {
		final String fileType = getFileType("C:\\Users\\NELSON\\Desktop\\a.pdf");
